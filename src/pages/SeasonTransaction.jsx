...
import { CalendarDays, Sprout, FileText, CheckCircle2, Circle } from "lucide-react";
    ...
    return (
        <div className="py-6 max-w-7xl mx-auto">
                ...
                <div className="bg-card border border-border rounded-2xl p-5 mb-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                        ...
                        {cropSeason.active ? (
                            ...
                            <Badge variant="outline" className="flex items-center gap-1.5 px-3 py-1 rounded-full text-xs text-muted-foreground">
            ...
            <Tabs defaultValue="expenses">
                <TabsList className="grid grid-cols-2 border-b border-border rounded-none bg-transparent p-0 h-auto">
                    <TabsTrigger
                        value="expenses"
                ...
                <TabsContent value="expenses" className="pt-5 mt-0">
                    <ExpenseForm cropSeason={cropSeason} />
                </TabsContent>
                <TabsContent value="income" className="pt-5 mt-0">
                    <IncomeForm cropSeason={cropSeason} />
                </TabsContent>
            </Tabs>
        </div>
    );
